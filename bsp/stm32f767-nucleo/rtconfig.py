...
if  CROSS_TOOL == 'gcc':
    PLATFORM 	= 'gcc'
    EXEC_PATH 	= r'/home/arno/workspace/rtt/gcc-arm-none-eabi-5_4-2016q3/bin'
...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -g -Wall -DSTM32F767xx -DUSE_HAL_DRIVER -D__ASSEMBLY__ -D__FPU_USED -eentry'
    ...
    CFLAGS = DEVICE + ' --apcs=interwork -DUSE_HAL_DRIVER -DSTM32F767xx'
    AFLAGS = DEVICE
    ...
    DEVICE = ' -D DUSE_HAL_DRIVER' + ' -D STM32F767xx'
